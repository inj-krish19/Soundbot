<link rel="icon" type="image/x-icon" href="./pages/images/logos/home.png">
<?php
...
<body>
    <nav>
        <ul>
            ...
            <li><a href="./pages/product.php?page=0" >Product</a></li>
            <?php
                ...
                if( $_SESSION["user"] == "guest" ){
                    ...
                    echo "<li><a href=userprofile.php><img src=". './pages/'.$imageLink ." ></a></li>";
                }

            ?>
        </ul>
    </nav>
    <img src="./pages/images/logos/Soundbot.png">
    <h1>Soundbot</h1>
</body>
<?php

    $file = "./pages/files/Home.txt";
